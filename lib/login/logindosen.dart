...
class LoginDosen extends StatefulWidget {
  LoginDosen({Key key, @required this.title}) : super(key: key);
  final String title;

  @override
  _LoginDosenState createState() => _LoginDosenState(title);
}
  ...
  void navigateLogin() async {
    ...
    if (isLogin == 1) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => DashboardDosen(title: "Home",)),
      );
    }
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Login Sebagai Dosen", style: TextStyle(color: Colors.white, fontSize: 40),),
                  SizedBox(height: 10,),
